...
.run(function($ionicPlatform) {
  ...
  milow.controller('FillCtrl', function ($scope, $http) {
    ...
    $scope.fcbook = function(index){
      window.plugins.socialsharing.shareViaFacebookWithPasteMessageHint($scope.ditados[index].pt+"\n"+$scope.ditados[index].kface, null /* img */, 'https://goo.gl/xlVtC5' /* url */, 'Copiado para a área de transferência! Cole para ver.', function() {console.log('share ok')}, function(errormsg){alert('Instale o facebook antes de continuar.')});
      //return alert($scope.ditados[index].pt+" "+"Pau");
    };
